...
import { FavoriteFile, Bookmark, BookmarksData, BookmarkIconType, ICON_TYPE_LABELS, FavoriteMode } from './types';
...
export class CodeAnchorProvider implements vscode.WebviewViewProvider {
  ...
  private favoriteMode: FavoriteMode = 'global'; // デフォルトはGlobal
